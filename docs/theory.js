...
- El sistema debe pedir un segundo factor antes de transferir a un destinatario nuevo.`
  ...
  {
    slug: "practica-multiple-choice",
    clase: "Práctica",
    titulo: "Práctica teórica (multiple choice)",
    orden: 39,
    resumen: "Preguntas de las clases 1 a 6 y de este laboratorio. Elegí una opción y comprobá; la explicación sale después.",
    contenido: `## Cómo se usa

No es la entrevista. Es para ver si la teoría quedó clara. Elegí **una** opción en cada pregunta y tocá **Comprobar**. La explicación aparece recién entonces.

Si querés agregar o cambiar preguntas, usá Editar: cada pregunta va en un bloque quiz. La respuesta correcta se marca con \`- [x]\`.

<!--quiz-->
Según Tukey, ¿qué conviene más en ingeniería de requerimientos?
- [ ] Resolver de forma exacta el problema, aunque no sea el correcto.
- [x] Resolver de forma aproximada el problema correcto.
- [ ] Empezar a programar y ajustar el problema después.
Por qué: Es mejor atacar el problema correcto, aunque sea aproximado, que resolver con precisión el problema equivocado.
<!--/quiz-->

<!--quiz-->
Si llamamos software solo al ejecutable, ¿qué se pierde?
- [ ] Nada: el programa ya contiene todo el conocimiento.
- [x] Diseños, requerimientos, decisiones y pruebas: el conocimiento del dominio.
- [ ] Solo la documentación de marketing.
Por qué: El software es información. Si solo miramos lo que corre, se pierde lo que permite mantenerlo y evolucionarlo.
<!--/quiz-->

<!--quiz-->
La deseconomía de escala en software dice que:
- [ ] Un sistema diez veces más grande cuesta aproximadamente diez veces más.
- [ ] Agregar personas siempre baja el costo por unidad, como en una fábrica.
- [x] Agrandar el sistema cuesta más que proporcionalmente: aparecen más vías de comunicación.
Por qué: Más gente y más partes no se escalan como ladrillos. Crece el costo de coordinar y de tener una visión global.
<!--/quiz-->

<!--quiz-->
¿Quién es un stakeholder?
- [ ] Solo quien firmó el contrato o paga el desarrollo.
- [x] Quien influye en los requerimientos o es impactado por el sistema, aunque no lo haya pedido.
- [ ] Solo los usuarios que van a tocar la pantalla.
Por qué: Wieringa y Glinz: stakeholder es quien influye o es impactado. Puede ganar o perder con el cambio sin haber sido consultado.
<!--/quiz-->

<!--quiz-->
Un gap semántico es:
- [ ] Un conflicto de prioridades entre dos sectores.
- [x] La misma palabra con dos significados distintos según quién habla.
- [ ] Un requerimiento que todavía no se escribió.
Por qué: El usuario habla el idioma del dominio y el analista el de la computación (o dos roles del dominio usan la misma palabra distinto). Hay que construir un acuerdo de significados.
<!--/quiz-->

<!--quiz-->
En el hospital, “urgente” para administración es “llegó sin turno” y para el médico es “no puede esperar”. Eso es:
- [ ] Un deseo.
- [ ] Un requerimiento de sistema.
- [x] Un gap semántico.
Por qué: Una sola palabra, dos mundos. Si no se pregunta, el sistema implementa una sola de las dos.
<!--/quiz-->

<!--quiz-->
Una necesidad, en este laboratorio, se escribe:
- [ ] Como “El sistema debe…” con verbo y condición observable.
- [x] Contando el problema de fondo: de qué dependen hoy y por qué eso motiva el proyecto.
- [ ] Como historia de usuario con criterio de aceptación.
Por qué: Necesidad, deseo y expectativa se cuentan como el dominio, no como un RF. Usuario y sistema quedan para más adelante.
<!--/quiz-->

<!--quiz-->
Un deseo se diferencia de una necesidad porque:
- [ ] El deseo es un RFN medible y la necesidad es un RF.
- [x] El deseo suma valor (fomenta adopción), pero el proyecto podría arrancar sin él.
- [ ] El deseo lo pide el gerente y la necesidad el usuario final.
Por qué: Sin la necesidad el proyecto no cumple su razón de ser. El deseo es extra atractivo, no indispensable.
<!--/quiz-->

<!--quiz-->
Una expectativa, en la práctica de este laboratorio, es:
- [ ] Un RFN escrito “El sistema debe responder en menos de 3 segundos”.
- [x] Qué esperan, en prosa: experiencia, costo, seguridad, no quedar atrás.
- [ ] Un botón o una pantalla que el usuario imagina.
Por qué: En los casilleros de la práctica se cuenta el dominio. El RFN medible es una especificación posterior.
<!--/quiz-->

<!--quiz-->
En esta práctica de laboratorio, los requerimientos de usuario y de sistema:
- [ ] Se escriben dos de cada uno, con “El usuario quiere” y “El sistema debe”.
- [x] No se piden: acá se trabaja el dominio, el interés, el conflicto y el gap si aparece.
- [ ] Se piden solo si el caso es el hospital.
Por qué: La pestaña Práctica no es para listar RF. Primero el mundo del problema.
<!--/quiz-->

<!--quiz-->
Loucopoulos define la elicitación como:
- [ ] Traducir lo que dijo el usuario a casos de uso y listo.
- [x] Adquirir o sonsacar todo el conocimiento relevante para modelar el dominio del problema.
- [ ] Validar la interfaz con un prototipo clickeable.
Por qué: El objetivo es entender el dominio. Sin ese conocimiento no hay especificación consistente ni completa.
<!--/quiz-->

<!--quiz-->
Si al especificar aparece un hueco (nadie dijo qué es “urgente”), ¿qué hay que hacer?
- [ ] Inventar un número razonable para no frenar.
- [x] Volver a elicitar: hay necesidad de más conocimiento.
- [ ] Pasar el hueco a un RFN de usabilidad.
Por qué: Especificación y elicitación se alimentan. El hueco obliga a volver a preguntar.
<!--/quiz-->

<!--quiz-->
El conflicto entre stakeholders, en la práctica, hay que:
- [ ] Resolverlo eligiendo al que paga.
- [x] Detectar al menos uno y dejarlo escrito, sacado del chat.
- [ ] Evitarlo para que el dominio quede limpio.
Por qué: Hacer visible el conflicto es trabajo del analista. No se pide diseñar la solución del conflicto en este laboratorio, sí detectarlo.
<!--/quiz-->

<!--quiz-->
Si en el chat no apareció un gap semántico, en el casillero correspondiente:
- [ ] Hay que inventar uno típico del dominio (por ejemplo “urgente”).
- [x] Se deja vacío: solo se anota si aparece.
- [ ] Se copia el ejemplo de la teoría para que no quede en blanco.
Por qué: No se inventan hechos. El gap es “si aparece”.
<!--/quiz-->

<!--quiz-->
Estudios de IBM y Bell Labs sobre defectos indican que:
- [ ] La mayoría de los defectos se insertan al programar.
- [x] Una parte muy grande se inserta en la fase de requerimientos, y corregirlos tarde cuesta mucho más.
- [ ] Los defectos de requerimientos casi no se pueden detectar hasta producción.
Por qué: Cerca del 80% se insertan en requerimientos. Corregir en un producto ya liberado puede costar entre 100 y 200 veces más.
<!--/quiz-->

<!--quiz-->
Un buen RFN (cuando más adelante se especifica) no puede quedar en:
- [ ] “El sistema debe estar disponible durante el horario de atención.”
- [x] “El sistema debe ser rápido, amigable y seguro.”
- [ ] “El sistema debe mostrar el resultado de una consulta en menos de 3 segundos.”
Por qué: Rápido, amigable y seguro no se prueban. Hace falta una cualidad medible: número, horario o prueba.
<!--/quiz-->
`
  },
  {
